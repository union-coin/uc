...
// Copyright (c) 2013 The UnionCoin developers
...
uint256 hashGenesisBlock("0x000002c33f5500b50d66212bda7260b759b2cf0d078096e9d405ba9f99544c6b");
static const unsigned int timeGenesisBlock = 1457683566;
...
const string strMessageMagic = "UnionCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "UnionCoin create 03.11";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xdcf35db35dc5b3f6d2cb5865580825cb0520eb8b300a3cccf5a484df4c9fb7aa"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UnionCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UnionCoinMiner : ProcessBlock, block not accepted");
    }
